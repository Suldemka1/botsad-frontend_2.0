        ...
        return (
            <>
                ...
                <div className="flex xs:flex-col gap-5">
                    ...
                    <div className="flex flex-wrap flex-row gap-5 md:w-8/12">
                        <input defaultValue={searchDocs.doc_title} placeholder="Поиск по заголовку" value={searchDocs.query}
                               ...
                               }} className='w-6/12 xs:w-full border border-black rounded px-2 outline-0 px-2 py-3'/>

                        <div className="flex flex-row xs:w-full xs:justify-between items-center gap-3">
                            <p>Поиск по типу</p>
