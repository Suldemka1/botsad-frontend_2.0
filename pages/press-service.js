    ...
    return (
        <div className="">
            ...
            <div className='text-xl'>
                ...
                <div>
                    <button className="bg-green-800 text-white border rounded py-2 px-3" onClick={() => {
                        handleModalOpen()
                    }}>
                        Предложить новость
                    </button>
                    ...
                    <dialog open={open}
                        ...
                        <div className="w-full h-full flex justify-center items-center">
                            <form method="dialog"
                                ...
                                <input type={'text'} placeholder="Заголовок новости" className="border border-black rounded-md p-2"
                                       onChange={(e) => {
                                           suggested_news.setTitle(e.target.value)
                                       }}/>

                                <textarea rows={10} placeholder="Текст новости"
                                          className="border border-black rounded-md resize-none z-50 p-2"
                                          onChange={(e) => {
                                ...
                                <input type={'text'} placeholder="Ссылка на источник" className="border border-black rounded-md p-2"
                                       onChange={(e) => {
